...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-brutal-bg">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="flex items-center justify-center">
          {/* Text Content - Centered */}
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="mb-6">
              <p className="text-brutal-accent font-bold text-lg mb-2 uppercase tracking-tight">Hello, I'm</p>
              <h1 className="text-5xl sm:text-6xl lg:text-8xl font-titulos text-brutal-text mb-4 uppercase tracking-tighter">
                Marcus Vinicius Ximenes
              </h1>
              <div className="text-2xl sm:text-3xl lg:text-4xl font-titulos text-brutal-text mb-6 uppercase">
                <span>I'm a </span>
                <span className="text-brutal-accent">
                  {roles[currentRole]}
                </span>
              </div>
            </div>

            <p className="text-lg text-brutal-text leading-relaxed mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                href="#projects"
                className="inline-block bg-brutal-accent text-white font-titulos uppercase px-8 py-4 rounded-none hover:bg-brutal-text transition"
              >
                View My Work →
              </a>
              ...
              <a
                href="#contact"
                className="inline-block bg-transparent text-brutal-text border-3 border-brutal-border font-titulos uppercase px-8 py-4 rounded-none hover:bg-brutal-accent hover:text-white hover:border-brutal-accent transition"
              >
                Get In Touch
              </a>
            </div>
            ...
            <div className="flex justify-center space-x-6">
              <a
                ...
                className="text-brutal-text hover:text-brutal-accent transform hover:scale-110 transition-all duration-200"
                aria-label="GitHub"
              >
