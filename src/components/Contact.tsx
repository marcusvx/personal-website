    ...
    <section id="contact" className="border-t-3 border-brutal-border bg-brutal-bg py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          {/* Contact Form */}
          <div className="rounded-none border-3 border-brutal-border bg-white p-8">
            <h3 className="mb-6 text-2xl font-titulos uppercase tracking-tight text-brutal-text">
              Send a Message
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="name"
                  className="mb-2 block text-sm font-bold uppercase text-brutal-text"
                >
                  Your Name
                </label>
                <input
                  ...
                  required
                  className="focus:border-brutal-accent w-full border-2 border-brutal-border bg-white px-4 py-3 text-brutal-text focus:outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="focus:border-brutal-accent w-full resize-none border-2 border-brutal-border bg-white px-4 py-3 text-brutal-text focus:outline-none"
              ...
              <button
                type="submit"
                className="w-full bg-brutal-accent px-6 py-3 font-titulos uppercase text-white transition-all duration-200 hover:bg-brutal-text"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="mb-8 text-lg leading-relaxed text-brutal-text">
